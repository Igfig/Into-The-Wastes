...
val castTools = [<thermalfoundation:tool.pickaxe_electrum>, <thermalfoundation:tool.hoe_electrum>, <thermalfoundation:tool.hammer_electrum>, <thermalfoundation:tool.shovel_electrum>, <thermalfoundation:tool.sickle_electrum>, <thermalfoundation:tool.hammer_electrum>, <thermalfoundation:tool.excavator_electrum>, <thermalfoundation:tool.pickaxe_platinum>, <thermalfoundation:tool.hoe_platinum>, <thermalfoundation:tool.hammer_platinum>, <thermalfoundation:tool.shovel_platinum>, <thermalfoundation:tool.sickle_platinum>, <thermalfoundation:tool.hammer_platinum>, <thermalfoundation:tool.excavator_platinum>] as IItemStack[];
