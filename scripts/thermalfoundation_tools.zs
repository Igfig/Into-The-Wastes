...
val castTools = [<thermalfoundation:tool.helmet_electrum>, <thermalfoundation:tool.plate_electrum>, <thermalfoundation:tool.legs_electrum>, <thermalfoundation:tool.boots_electrum>, <thermalfoundation:tool.sword_electrum>, <thermalfoundation:tool.pickaxe_electrum>, <thermalfoundation:tool.axe_electrum>, <thermalfoundation:tool.hoe_electrum>, <thermalfoundation:tool.shovel_electrum>, <thermalfoundation:tool.sickle_electrum>, <thermalfoundation:tool.hammer_electrum>,  <thermalfoundation:tool.excavator_electrum>, <thermalfoundation:tool.helmet_platinum>, <thermalfoundation:tool.plate_platinum>, <thermalfoundation:tool.legs_platinum>, <thermalfoundation:tool.boots_platinum>, <thermalfoundation:tool.sword_platinum>, <thermalfoundation:tool.pickaxe_platinum>, <thermalfoundation:tool.axe_platinum>, <thermalfoundation:tool.hoe_platinum>, <thermalfoundation:tool.shovel_platinum>, <thermalfoundation:tool.sickle_platinum>, <thermalfoundation:tool.hammer_platinum>, <thermalfoundation:tool.excavator_platinum>] as IItemStack[];
