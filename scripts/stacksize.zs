...
function setStackSize(entry as IOreDictEntry, size as int) as bool {
	val keepStacked = ["Cactus", "Slime", "Emerald", "Prismarine", "Glass", "Mud", "nugget", "Wood", "Wool", "wool", "Rock", "charred", "frozen", "Clay", "Sand", "Stone", "Brick", "Meat", "Goldenrod", "Concrete"] as string[]; // for some reason this definition has to be inside the function or it breaks?
