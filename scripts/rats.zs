...
mods.jei.JEI.addDescription([<animania:friesian_cheese_wedge>, <animania:holstein_cheese_wedge>, <animania:jersey_cheese_wedge>, <animania:goat_cheese_wedge>, <animania:sheep_cheese_wedge>], "Used to tame rats. Throw cheese on the ground repeatedly near a wild rat to tame one.");


// new stats and recipe for Chunky Cheese Token
...
token.addTooltip(format.red("Your ticket out of here"));
