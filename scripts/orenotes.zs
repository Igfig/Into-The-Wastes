<minecraft:coal_ore>.addTooltip("Appears everywhere");
<minecraft:iron_ore>.addTooltip("Appears in mines in oases");
<minecraft:gold_ore>.addTooltip("Appears in mines in oases");
<minecraft:redstone_ore>.addTooltip("Appears in oases");
<minecraft:lapis_ore>.addTooltip("Appears in oases");
<minecraft:diamond_ore>.addTooltip("Appears in oases");
...
<biomesoplenty:gem_ore:4>.addTooltip("Appears in mines in snowy areas"); // tanzanite
...
<thermalfoundation:ore_fluid:3>.addTooltip("Appears in nether quartz mines");
