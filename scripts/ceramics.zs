...
<ceramics:faucet>.addTooltip("Right-click or power with redstone to activate");

<ceramics:channel>.addTooltip("Right-click on input/output sides to change direction of flow");